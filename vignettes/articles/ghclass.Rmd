...
<img src="figure//test_token.svg" title="plot of chunk test_token" alt="plot of chunk test_token" width="100%" />
...
<img src="figure//bad_token.svg" title="plot of chunk bad_token" alt="plot of chunk bad_token" width="100%" />
...
<img src="figure//sitrep.svg" title="plot of chunk sitrep" alt="plot of chunk sitrep" width="100%" />
...
<img src="figure//set_perm.svg" title="plot of chunk set_perm" alt="plot of chunk set_perm" width="100%" />
...
<img src="figure//sitrep2.svg" title="plot of chunk sitrep2" alt="plot of chunk sitrep2" width="100%" />
...
<img src="figure//roster.svg" title="plot of chunk roster" alt="plot of chunk roster" width="100%" />
...
<img src="figure//invite.svg" title="plot of chunk invite" alt="plot of chunk invite" width="100%" />
...
<img src="figure//members.svg" title="plot of chunk members" alt="plot of chunk members" width="100%" />
...
<img src="figure//members2.svg" title="plot of chunk members2" alt="plot of chunk members2" width="100%" />
...
<img src="figure//pending.svg" title="plot of chunk pending" alt="plot of chunk pending" width="100%" />
...
<img src="figure//members3.svg" title="plot of chunk members3" alt="plot of chunk members3" width="100%" />
...
<img src="figure//pending2.svg" title="plot of chunk pending2" alt="plot of chunk pending2" width="100%" />
...
<img src="figure//is_template.svg" title="plot of chunk is_template" alt="plot of chunk is_template" width="100%" />
...
<img src="figure//set_template.svg" title="plot of chunk set_template" alt="plot of chunk set_template" width="100%" />
...
<img src="figure//is_template2.svg" title="plot of chunk is_template2" alt="plot of chunk is_template2" width="100%" />
...
<img src="figure//create_team_assign.svg" title="plot of chunk create_team_assign" alt="plot of chunk create_team_assign" width="100%" />
...
<img src="figure//create_ind_assign.svg" title="plot of chunk create_ind_assign" alt="plot of chunk create_ind_assign" width="100%" />
...
<img src="figure//repos.svg" title="plot of chunk repos" alt="plot of chunk repos" width="100%" />
...
<img src="figure//repos_filter.svg" title="plot of chunk repos_filter" alt="plot of chunk repos_filter" width="100%" />
...
<img src="figure//add_file.svg" title="plot of chunk add_file" alt="plot of chunk add_file" width="100%" />
...
<img src="figure//get_readme.svg" title="plot of chunk get_readme" alt="plot of chunk get_readme" width="100%" />
...
<img src="figure//modify_file.svg" title="plot of chunk modify_file" alt="plot of chunk modify_file" width="100%" />
...
<img src="figure//get_readme2.svg" title="plot of chunk get_readme2" alt="plot of chunk get_readme2" width="100%" />
...
<img src="figure//local_clone.svg" title="plot of chunk local_clone" alt="plot of chunk local_clone" width="100%" />
...
<img src="figure//dir.svg" title="plot of chunk dir" alt="plot of chunk dir" width="100%" />
...
A couple other quick points about this change:
    ...
    - Currently, our recommendation is if your classroom org is already using `master` to leave it as is, particularly for repos already distributed to students.
    - For new classroom orgs, before the change, you can make the change organization wide under `Org > Settings > Repository Defaults > Repository default branch`. Note that this will only affect newly created repositories, not existing repositories.
