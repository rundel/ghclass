...
org_set_repo_permission("ghclass-vignette", "read")
```
...
We can see that this function indicates that the current default repository permission setting is "read" and provides a helpful warning that this enables members to view all repositories.
...
```{r}
#| label: set_perm
org_set_repo_permission("ghclass-vignette", repo_permission = "none")
```
