...
```r
org_invite("Sta523-Fa17", roster$github)
...
`org_memberss` function, and pending invitations using the `org_pending_memberss`
...
earlier. You can do this with the `repo_mirror` function.

```r
repo_mirror(
  source_repo = "Sta523-Fa17/hw2",
  target_repos = org_repos("Sta523-Fa17","hw2-")
)
...
```r
add_wercker(org_repos("Sta523-Fa17", "hw2-"), "Sta523-Fa17")
