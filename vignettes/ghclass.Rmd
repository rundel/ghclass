...
Using the `roster` data frame, we can then invite the students to the class' organzation. This will send and email to each students inviting them to join the GitHub organization.
