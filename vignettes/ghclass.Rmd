...
Python user, see [this
post](https://ubc-mds.github.io/2017-08-24-teaching-with-github/) for a Python
=======
This package is for everyone! But really, if you're an instructor who uses 
GitHub for your class management, e.g. students submit assignments via GitHub 
repos, this package is definitely for you! The package also assumes that you're 
...
>>>>>>> 7e37024be081034ec053107d330edd9663b2827b
based alternative.)
...
organzation. This will send and email to each student inviting them to join the
GitHub organization.
...
We use the variable `team` within the `roster` data frame to create teams
within the organization and add students to their teams.
...
function. Note that if students are first-time GitHub users, they will need to
