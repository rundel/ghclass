...
You can check which students are added to the organization using `get_members` and pending invitations using `get_pending_members` functions.
...
```r
create_team_repo("Sta523-Fa17", prefix="hw2-")
