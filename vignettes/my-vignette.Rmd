...
1. Create an organization on GitHub for the course.

  - Naming recommendation: We recommend you use the course number, semester, and
  year, e.g. for a course numbered Sta 199 in Spring 18, you can use 
  `Sta199-Sp18`.

2. Apply for GitHub Education credits ([here](https://education.github.com/discount_requests/new)) 
so that you can get unlimited private repositories for your students' 
assignment repos.

  - This is actually an optional step, but one that many will want to do. GitHub
  charges for private repositories unless they are used for teaching purposes. 
  To take advantage of this promotion you need to apply for GitHub Education.
  - The application will require that you submit a course syllabus and/or a 
  link to the course homepage. Make sure you have (at least a draft of) a 
  syllabus ready at this point.
  - Approval is usually pretty quick, but you don't wnat to do this the night 
  before classes begin. Give yourself at least a week to be safe.
